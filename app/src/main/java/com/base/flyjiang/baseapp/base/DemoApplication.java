...
/**
 * Created by ${flyjiang} on 2016/6/30.
 * 文件说明：Application
 */
public class DemoApplication extends MultiDexApplication {
    ...
    public void onCreate() {
        ...
        CrashReport.initCrashReport(getApplicationContext(), "f563dcba5f", true);
        //基础信息初始化
        initBase();
        x.Ext.init(this);
        //图片下载初始化
        ...
        Dexter.initialize(this); //权限处理初始化
        if (bdLocation == null) {
            bdLocation = new BDLocation(this);
        }
 ...
 /*   @Override
    ...
    private void initOkGo() {
        ...
        try {
            HttpsUtils.SSLParams sslParams3 = HttpsUtils.getSslSocketFactory(getAssets().open("ca.crt"));
