package com.base.flyjiang.baseapp.callback;
import android.app.Activity;
import android.app.Dialog;

import com.base.flyjiang.baseapp.bean.CommonReturnData;
import com.base.flyjiang.baseapp.model.SimpleResponse;
import com.base.flyjiang.baseapp.utils.Convert;
...
public abstract class DialogCallback<T> extends JsonCallback<T> {
  ...
  public DialogCallback(Activity activity) {
    ...
    public void onStart(Request<T, ? extends Request> request) {
        ...
        dialog =  StyledDialog.buildLoading("测试加载中...").setActivity(mActivity).show();
    }
