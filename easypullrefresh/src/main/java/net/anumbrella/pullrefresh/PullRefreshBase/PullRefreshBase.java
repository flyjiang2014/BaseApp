...
public abstract class PullRefreshBase<T extends View> extends LinearLayout implements IPullRefresh<T> {
    ...
    public PullRefreshBase(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
        Log.e("jiang07",this.getChildCount()+"jiang");
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        Log.e("jiang03",this.getChildCount()+"");
        addRefreshableView(context, mRefreshableView);
        Log.e("jiang04",this.getChildCount()+"");
        addHeaderAndFooter(context);
        Log.e("jiang05",this.getChildCount()+"");
    ...
    protected void addRefreshableView(Context context, T refreshableView) {
        ...
        Log.e("jiang08",this.getChildCount()+"jiang");
    }
