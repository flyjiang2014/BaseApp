...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public List<Integer> getListNotice() {
        return listNotice;
    }

    public void setListNotice(List<Integer> listNotice) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float lineLeft = currentTab.getLeft() + textViewCurrent.getLeft();// textViewCurrent.getLeft()是相对currentTab的左边距离
        float lineRight = lineLeft + textViewCurrent.getWidth();
        ...
        if (currentPositionOffset > 0f && currentPosition < tabCount - 1) {
            ...
            final float nextTabRight = nextTabLeft + textViewNext.getWidth();
