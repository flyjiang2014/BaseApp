 ...
 */
public class ViewFlow extends AdapterView<Adapter> implements Handler.Callback {
    ...
    protected void onScrollChanged(int h, int v, int oldh, int oldv) {
        ...
        if (mIndicator != null) {
            ...
            int hPerceived = h + (mCurrentAdapterIndex - mCurrentBufferIndex)
                    * getWidth();
            Log.i("onScrollChanged", "onScrollChanged h:" + hPerceived);
    ...
    private void snapToScreen(int whichScreen) {
        ...
        // int hPerceived = getScrollX() + (mCurrentAdapterIndex -
        // mCurrentBufferIndex)
        // * getWidth();
